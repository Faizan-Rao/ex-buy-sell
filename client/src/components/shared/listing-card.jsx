...
export default function ListingCard({ listing, featured = false }) {
  ...
  return (
    <div className="rounded-lg   bg-[#FAFAFA] overflow-hidden">
      ...
      <div className="p-4">
        <h3 className="text-lg md:!text-base font-semibold font-lufga mb-1 text-black">
          {listing.title}
        </h3>
        <p className="text-xs text-black/50 mb-3 font-lufga">
          {listing.description}
        </p>
        <div className="flex flex-row justify-between items-center mb-4">
          <div className="text-[24px] md:!text-[22px] font-semibold font-lufga text-black">
            ${listing.price.toLocaleString()}
          </div>
          <div className="flex flex-row justify-center items-center border-[2px] border-[#808080] px-3  rounded-[60px]">
            <p className=" text-[10px] md:text-xs font-medium font-lufga pr-2.5 py-1 text-black/70">
              Multiple 1.1x Profit
            </p>
            <hr className="inline-block h-full min-h-[1.9em] w-0.5 self-stretch bg-[#808080] " />
            <p className="text-[10px] md:text-xs font-medium font-lufga pl-2.5 py-1 text-black/70">
              0.3x Revenue
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm md:text-base font-medium text-black/50 font-lufga">
              Location: <span className="text-black">{listing.location}</span>
            </span>
          </div>
          <div className="text-sm md:text-base font-medium text-black/50 font-lufga text-right">
            Business Age:{" "}
            <span className="text-black">{listing.businessAge}</span>
          </div>

          <div className="text-sm md:text-base font-medium text-black/50 font-lufga">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <Button
            variant={"default"}
            className={
              "px-[10px] py-[13px] max-w-[212px] h-[48px] w-full text-[14px] bg-[black] rounded-[60px] text-white font-semibold text-center"
            }
          >
            Contact Seller
          </Button>
          <Button
            variant={"default"}
            className={
              "px-[10px] py-[13px] max-w-[212px] h-[48px] hover:text-white w-full text-[14px] bg-[#C5FD1F] rounded-[60px] font-semibold text-black text-center"
            }
          >
            View Listing
          </Button>
