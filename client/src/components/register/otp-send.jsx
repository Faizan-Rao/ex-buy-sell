    ...
    <div className="w-full md:w-full flex flex-col p-6 md:p-10 lg:p-20">
      <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-600 text-lg  font-normal mb-2 text-center font-sora mb-8">
          ...
          <div className="flex mb-6 border-1  rounded-[60px] ">
            <span className="  flex border-r-[1px]">
              ...
              >
                ...
                <SelectContent className={"ring-0 outline-0 border-0 focus:border-0"}>
                  {countryValues.map((country, index) => (
                    <div key={`${country.name}`}>
                      {isSupportedCountry(getCountryCode(country.name)) && (
                        <SelectItem
...
;
          ...
          {/* Continue Button */}
          <button className="w-full py-3 bg-[#d0ff00] text-black w-full font-sora font-medium rounded-full !mb-8">
            Continue
          </button>
