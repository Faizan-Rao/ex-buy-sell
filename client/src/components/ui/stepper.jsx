...
const StepperTrigger = React.forwardRef(({ asChild = false, className, children, ...props }, ref) => {
...
const StepperIndicator = React.forwardRef(({ asChild = false, className, children, ...props }, ref) => {
  ...
  return (
    (<div
      ref={ref}
      className={cn(
        "relative flex size-6 shrink-0 items-center justify-center rounded-full bg-muted text-xs font-medium text-muted-foreground data-[state=active]:bg-[#0067FF] data-[state=completed]:bg-[#0067FF] data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground",
        className
      )}
      data-state={state}
      {...props}>
